...
public class EventCreationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set up the "Post Event" button
        Button postEventButton = view.findViewById(R.id.btnPostEvent);
        ...
        // Uncomment and update these if you add the corresponding buttons to your layout:
